...
export const DEMO_ACCOUNTS = [
  { name: 'Vacation', type: 'chequing', balance: 9.65, currency: 'CAD' },
  { name: 'TFSA', type: 'investment', balance: 483.28, currency: 'CAD' },
  { name: 'Starbucks Card', type: 'gift', balance: 1.90, currency: 'CAD' },
];
